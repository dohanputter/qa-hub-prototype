...
import { getSnippets, createSnippet, updateSnippet, deleteSnippet } from '../services/mockData';
...
export const Snippets: React.FC<SnippetsProps> = ({ onBack }) => {
  ...
  const confirmDelete = () => {
    if (snippetToDelete !== null) {
        ...
        refreshSnippets();
        addToast("Snippet deleted successfully", "info");
                             ...
                             <div className="flex items-center bg-white border border-gray-300 rounded-lg overflow-hidden">
                                <button 
                                    ...
                                    className={`px-3 py-1.5 text-xs font-medium flex items-center gap-1.5 ${
                                        currentSnippet.type === 'test_case' ? 'bg-blue-50 text-blue-700' : 'hover:bg-gray-50 text-gray-500'
                                    }`}
                                >
                                ...
                                <button 
                                    ...
                                    className={`px-3 py-1.5 text-xs font-medium flex items-center gap-1.5 ${
                                        currentSnippet.type === 'issue' ? 'bg-orange-50 text-orange-700' : 'hover:bg-gray-50 text-gray-500'
                                    }`}
                                >
